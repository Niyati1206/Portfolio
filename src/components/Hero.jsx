    ...
    {/* Dynamic Typing Text Here */}
        ...
        <p className='text-base sm:text-lg md:text-xl lg:max-w-[30rem] text-gray-400 max-w-[25rem] tracking-wider'>
            ...
            <div className='flex gap-4 mt-12'>
                <a className='border border-[#2a2a2a] py-2 sm:py-3 px-4 sm:px-5 rounded-full sm:text-lg text-sm font-semibold tracking-wider transition-all duration-300 hover:bg-[#1a1a1a]'href="#">Resume <i class='bx bx-link-external'></i></a>

                <a className='border border-[#2a2a2a] py-2 sm:py-3 px-8 sm:px-10 rounded-full sm:text-lg text-sm font-semibold tracking-wider transition-all duration-300 hover:bg-[#1a1a1a] bg-gray-300 text-black hover:text-white'href="#">Let's Connect <i class='bx bx-link-external'></i></a>
            </div>
     </div>
     {/* 3D Robot */}
